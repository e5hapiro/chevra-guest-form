...
/*
    ...
    // --- Hydrate the object with new properties ---
    ...
    // NOTE: If you refactor createHourlyShifts_ later, you could just pass the whole object:
    // const allNewShifts = createHourlyShifts_(eventData);
    ...
    // --- Hydrate the object with formatted strings for email ---
    eventData.startDateTimeStr = eventData.startDate.toLocaleDateString('en-US', { weekday: 'long', hour: 'numeric', minute: '2-digit' });
    eventData.endDateTimeStr = eventData.endDate.toLocaleDateString('en-US', { weekday: 'long', hour: 'numeric', minute: '2-digit' });

    // --- QC LOG 4: Before Email Send ---
    // Log the entire data object to see its final state
    logQCVars_("Before Email Notification", eventData);
